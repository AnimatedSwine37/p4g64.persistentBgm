...
internal class Utils
{
    ...
    internal static void LogDebug(string message)
    {
        if (_config.DebugEnabled)
            _logger.WriteLine($"[Persistent BGM] {message}");
    }
    ...
    {
        _logger.WriteLine($"[Persistent BGM] {message}: {e.Message}", System.Drawing.Color.Red);
    }

    internal static void LogError(string message)
    {
        _logger.WriteLine($"[Persistent BGM] {message}", System.Drawing.Color.Red);
    }
